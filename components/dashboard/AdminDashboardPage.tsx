...
const ActivityIcon: React.FC<{type: Activity['type']}> = ({type}) => {
    ...
    switch(type) {
        ...
        case 'user_registered':
            return <div className={`bg-indigo-100 text-indigo-600 ${containerClasses}`}><UsersIcon className={iconClasses} /></div>;
        default:
            return null;
    }
}
    ...
    return (
        <div>
            <div className="mb-8">
                ...
                <p className="text-gray-600 mt-1">{translations.dashboardOverview}</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <StatCard 
                    ...
                    title={translations.openSupportTickets}
                    value="12"
                />
                 <StatCard 
            ...
            <div className="mt-12 bg-white p-6 rounded-lg shadow-md">
                <h2 className="text-xl font-bold text-dark mb-4">{translations.recentActivity}</h2>
